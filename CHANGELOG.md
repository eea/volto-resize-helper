...
### [3.0.1](https://github.com/eea/volto-resize-helper/compare/3.0.0...3.0.1) - 8 April 2026

#### :bug: Bug Fixes

- fix: make test [Alin V. (Claudiu) - [`2ac128f`](https://github.com/eea/volto-resize-helper/commit/2ac128ffa00d8065116e9e92152f7fc207a32fe3)]

## [3.0.0](https://github.com/eea/volto-resize-helper/compare/2.0.0...3.0.0) - 25 March 2026

#### :rocket: New Features

- feat: Volto 18 support - refs #287700 [Alin Voinea - [`8625bf4`](https://github.com/eea/volto-resize-helper/commit/8625bf4dffedff755c7dbb2486a4301ec2be60d7)]

#### :house: Internal changes

- chore: [JENKINSFILE] add package version in sonarqube [valentinab25 - [`60d9a1f`](https://github.com/eea/volto-resize-helper/commit/60d9a1fc47c468f74623df1c68b2c10a5ab40fcf)]
- chore: [JENKINSFILE] use sonarqube branches [EEA Jenkins - [`50da1d4`](https://github.com/eea/volto-resize-helper/commit/50da1d493ae44a7c8fa35a0486d14aacde936c8f)]

#### :hammer_and_wrench: Others

- tests: Fix Sonar Qube tags - refs #297339 [Alin Voinea - [`c058313`](https://github.com/eea/volto-resize-helper/commit/c0583130910118aa3b9a2606ec5383beb2639e59)]
- Add Sonarqube tag using clms-frontend addons list [EEA Jenkins - [`c1bc6e7`](https://github.com/eea/volto-resize-helper/commit/c1bc6e75eebe3edaa15627100161bda6da3bbde7)]
- Add Sonarqube tag using clms-frontend addons list [EEA Jenkins - [`f06f458`](https://github.com/eea/volto-resize-helper/commit/f06f458bbacc2aaff26efe71d0daafcb5f080b77)]
- Add Sonarqube tag using eea-website-frontend addons list [EEA Jenkins - [`1363e9a`](https://github.com/eea/volto-resize-helper/commit/1363e9a29da1102e057600bff74353b75d89b3b2)]
- Add Sonarqube tag using eea-website-frontend addons list [EEA Jenkins - [`94be945`](https://github.com/eea/volto-resize-helper/commit/94be945d175d85dc5440893e78a696071252bb8b)]
- Add Sonarqube tag using clms-frontend addons list [EEA Jenkins - [`6d8b7a3`](https://github.com/eea/volto-resize-helper/commit/6d8b7a3055a72c97e9a74184c8b89db565f900bc)]
- Add Sonarqube tag using ied-frontend addons list [EEA Jenkins - [`daca969`](https://github.com/eea/volto-resize-helper/commit/daca96992a6230aee0f17acdd0daa438c680539b)]
...
- chore: [JENKINS] Refactor automated testing [valentinab25 - [`dedeb7b`](https://github.com/eea/volto-resize-helper/commit/dedeb7bcdc6b04a2ea1e4b1044ed42a009ff479c)]
...
- Add Sonarqube tag using insitu-frontend addons list [EEA Jenkins - [`e517d2b`](https://github.com/eea/volto-resize-helper/commit/e517d2b2479b651c5b4ff300c664355d9d93f1db)]
- Add Sonarqube tag using freshwater-frontend addons list [EEA Jenkins - [`802a9b1`](https://github.com/eea/volto-resize-helper/commit/802a9b1f27c741e65ec1a650d0814f645eaa738f)]
- Add Sonarqube tag using insitu-frontend addons list [EEA Jenkins - [`a6dd705`](https://github.com/eea/volto-resize-helper/commit/a6dd7053150a0bf0f2b988f2f930739fccd1f221)]
- test: [JENKINS] Use java17 for sonarqube scanner [valentinab25 - [`24a2768`](https://github.com/eea/volto-resize-helper/commit/24a27681ec6fd31abc8f7c120a9f5467d0c52842)]
- test: [JENKINS] Run cypress in started frontend container [valentinab25 - [`af29ab8`](https://github.com/eea/volto-resize-helper/commit/af29ab86b2ff9344cd87ab54dc1ec75e7affc4b2)]
- test: [JENKINS] Add cpu limit on cypress docker [valentinab25 - [`99ef05a`](https://github.com/eea/volto-resize-helper/commit/99ef05aebe4c56cca3f92c62ab215a2942c31ab2)]
- test: [JENKINS] Increase shm-size to cypress docker [valentinab25 - [`f7f7faf`](https://github.com/eea/volto-resize-helper/commit/f7f7faf32cab2e0c1e3363ea4c8041344ecdfb60)]
- test: [JENKINS] Improve cypress time [valentinab25 - [`72f72cf`](https://github.com/eea/volto-resize-helper/commit/72f72cf3a479278e59ace723a8f56fe2c3fa393d)]
